...
SYSTEM_PROMPT = """Você é um redator técnico especializado em documentação de software.
...
desenvolvedor conseguiria entender e rodar o projeto apenas com a documentação disponível.""" + JSON_OUTPUT_INSTRUCTIONS
