    ...
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-1.5">
          {summary.branches.length === 0 && <p className="text-sm text-muted-foreground">Nenhuma branch encontrada.</p>}
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          {summary.recent_commits.length === 0 && <p className="text-sm text-muted-foreground">Sem commits.</p>}
      ...
      <Card className="lg:col-span-2">
        ...
        <CardContent className="flex flex-wrap gap-3">
          {summary.contributors.length === 0 && <p className="text-sm text-muted-foreground">Nenhum contribuidor encontrado.</p>}
          {summary.contributors.map((c) => (
            <div key={c.username} className="flex items-center gap-2 rounded-full border border-border py-1 pl-1 pr-3 text-sm">
              {c.avatar_url ? (
